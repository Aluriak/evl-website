...
SSH_HOST=51.158.150.197
SSH_PORT=9834
SSH_USER=lucas
SSH_TARGET_DIR=/home/lucas/www/ecovillage-la-lanterne.net
...
help:
	...
	@echo '   make upload                   compile + ssh upload'
	@echo '                                                                          '
...
ssh_upload: publish
	- ssh -p $(SSH_PORT) "$(SSH_USER)@$(SSH_HOST)" "rm -r $(SSH_TARGET_DIR)/*"
